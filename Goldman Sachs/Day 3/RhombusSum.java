...
public class RhombusSum {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(new Solution().getBiggestThree(new int[][]{{3,4,5,1,3},{3,3,4,2,3},{20,30,200,40,10},{1,5,5,4,1},{4,3,2,2,5}})));
        System.out.println(Arrays.toString(new Solution().getBiggestThree(new int[][]{{1,2,3},{4,5,6},{7,8,9}})));
    }
}
